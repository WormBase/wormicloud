    ...
    return (
        <Container fluid>
            <Row>
                ...
                <Col sm={props.showNumCuratedObjects ? 3 : 4}><a target="_blank" rel="noopener noreferrer" href={"https://wormbase.org/resources/paper/" + props.element.wb_id}><p dangerouslySetInnerHTML={{__html: props.element.title}}/></a></Col>
                ...
                {props.showNumCuratedObjects
                    ?
                    <Col sm={1}>{props.element.num_curated_entities}</Col>
                    :
                    null
                }
            </Row>
