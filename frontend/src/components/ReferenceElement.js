    ...
    return (
        <Container fluid>
            <Row>
                ...
                <Col sm={3}><a target="_blank" rel="noopener noreferrer" href={"https://wormbase.org/resources/paper/" + props.element.wb_id}><p dangerouslySetInnerHTML={{__html: props.element.title}}/></a></Col>
